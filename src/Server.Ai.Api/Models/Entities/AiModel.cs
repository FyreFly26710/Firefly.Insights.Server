...
public static class AiModelsSeed
{
    public static List<AiModel> GetAiModels(IConfiguration configuration)
    {
        ...
        var deepSeekApiKey = configuration.GetValue<string>("DeepSeek:ApiKey") ?? string.Empty;
        ...
        var deepSeekProvider = new AiProvider { Name = "DeepSeek", ApiKey = deepSeekApiKey };
        ...
        string AVATAR_DEEPSEEK = "https://cdn.deepseek.com/platform/favicon.png";
        return [
            ...
            new() { AiProvider = deepSeekProvider, Model = "deepseek-chat", ModelId = "deepseek-chat", InputPrice = 0.28M, OutputPrice = 0.42M, DisplayName = "DeepSeek Chat", Avatar = AVATAR_DEEPSEEK },
            new() { AiProvider = deepSeekProvider, Model = "deepseek-reasoner", ModelId = "deepseek-reasoner", InputPrice = 0.28M, OutputPrice = 0.42M, DisplayName = "DeepSeek Reasoner", Avatar = AVATAR_DEEPSEEK },
        ];
    }
}