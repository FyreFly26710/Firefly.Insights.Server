// Forked from:
// https://github.com/niltor/DeepSeekSDK-NET/blob/dev/src/DeepSeek.Core/Adapters/DeepSeekChatClient.cs
//

using Microsoft.Extensions.AI;
using Server.Ai.DeepSeek.Models;
using System.Runtime.CompilerServices;
using System.Text.Json;

namespace Server.Ai.DeepSeek;
